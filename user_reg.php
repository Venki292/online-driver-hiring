...
<body>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slider-content_wrap">
                                    ...
                                    <h2 style="font-weight:bold;color:#FF2F6D ; text-shadow: 2px 2px 4px #000000; text-shadow: 2px 2px 5px white;">User Registration</h2>
                                </div>
                                </div>
                            </div>
                        </div>
    ...
    <input type="text" class="form-control" name="aadharnumber" required="required"  placeholder="Aadhar number">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <textarea class="form-control" name="discription">Description...
   </textarea>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   
   <input type="submit" class="btn btn-danger" name="register" value="Register">
	</form>
	<a href="user_login.php"><button class="btn btn-success">Login</button></a>
	</div>
	</div>
...
$tmp_name=$_FILES["myimage"]["tmp_name"];
	...
	(`name`, `age`, `address`, `mobile`, `email`, `password`,`aadharnumber`, `country`, `state`, `city`, `image`, `discription`)values
	('$driname', '$age', '$address', '$mobile', '$email', '$password','$aadharnumber','$country', '$state', '$city', '$name', '$discription')";
