...
<body>
	...
	<div id="booking" class="section">
		...
		<center><div class="alert alert-danger" style="width:800px; height:50px; font-size:18px"><center>
  <strong>Book Your Driver </strong>  </center>
</div></center>
			<div class="container">
				<div class="row">
					<div class="col-lg-2">
...
<div style="br: 15px;
  ...
  <input type="text" style="color:#07090A; font-weight:bold" name="source" placeholder="source" class="form-control"></br>
 <input type="text" style="color:#07090A; font-weight:bold" name="destination" placeholder="destination" class="form-control"></br>
 ...
 <input type="text" style="color:#07090A; font-weight:bold" name="email" placeholder="Email" class="form-control"></br></br></br></br>
  <input type="submit" class="btn btn-danger btn-lg btn-block" name="final_booking" value="confirm">
  ...
  if(isset($_REQUEST['final_booking']))
  {
	  ...
	  extract($_REQUEST);
	$query="INSERT INTO `booking`(`city`, `date`, `duration`, `name`,`source`,`destination`,`mobile`, `email`, `vehical`, `driverid`, `status`)
	VALUES
	('$city', '$date', '$duration', '$name','$source','$destination', '$mobile', '$email','$vehical','$driverid','0')";
	
	
	 $n=iud($query);
	 if($n==1)
	 {
		 echo'<script>alert("Driver Will  Contact You Very Soon For Final Confirmation")
