...
<body>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slider-content_wrap">
                                    ...
                                    <h2 style="font-weight:bold;color:#FF2F6D ; text-shadow: 2px 2px 4px #000000; text-shadow: 2px 2px 5px white;">Driver Registration</h2>
                                </div>
                                </div>
                            </div>
                        </div>
	...
	<option value="HMV" >High Motor Vehicle</option>
	</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <span>licence</span><input type="file" name="myimage" class="form-control" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
