                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slider-content_wrap">
                                    ...
                                    <h2 style="font-weight:bold;color:#FF2F6D ; text-shadow: 2px 2px 4px #000000; text-shadow: 2px 2px 5px white;">Choose Any Driver</h2>
                                </div>
                                </div>
                            </div>
                        </div>
	...
	<div class="col-lg-3" style="border: 5px solid #eee; margin: 20px">
       <div>
           <div  style="padding: 5px">
               ...
               <h4 style="background-color:#FF2F6D;color:white;text-align:center"><?=ucwords($r[1]);?></h4>
               <h6>Charge Per Hour- <?=ucwords($r[7]);?></h6>
               <h6>Mobile No.- <?=ucwords($r[4]);?></h6>
               <h6>Address- <?=ucwords($r[3]);?></h6>
               <p><?=ucwords($r[12])?> </p>
			   <a href="final_book.php?vehical=<?=$_REQUEST['vehical']?>&driverid=<?=$r[0]?>&city=<?=$_REQUEST['city']?>"><button class="btn" name="book" style="background-color:#FF2F6D;color:white;font-weight:bold;font-size:20px">Book</button>
           </a></div>
           </div>
           </div>
		   <?php
